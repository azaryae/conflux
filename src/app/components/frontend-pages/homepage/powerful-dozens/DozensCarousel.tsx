    ...
    <>
      <Slider {...settings} className="dozenscarousel">
        <div>
          ...
          >
            <Link href="https://conflux.ai-nextjs.adminmart.com/">
              <img
        ...
        <div>
          <Box
            ...
            sx={{ boxShadow: (theme) => theme.shadows[10] }}
          >
            <Link href="https://conflux.ai-nextjs-dark.vercel.app/dashboards/ecommerce">
              <img
        ...
        <div>
          <Box
            ...
            sx={{ boxShadow: (theme) => theme.shadows[10] }}
          >
            <Link href="https://conflux.ai-nextjs-horizontal.vercel.app/dashboards/modern">
              <img
        ...
        <div>
          <Box
            ...
            sx={{ boxShadow: (theme) => theme.shadows[10] }}
          >
            <Link href="https://conflux.ai-nextjs.adminmart.com/apps/chats">
              <img
        ...
        <div>
          <Box
            ...
            sx={{ boxShadow: (theme) => theme.shadows[10] }}
          >
            <Link href="https://conflux.ai-nextjs.adminmart.com/apps/email">
              <img
